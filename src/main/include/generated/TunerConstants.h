...
public:
    ...
    // This needs to be tuned to your individual robot
    static constexpr units::meters_per_second_t kSpeedAt12Volts = 4.71_mps;
...
private:
    ...
    static constexpr units::inch_t kWheelRadius = 1.99_in;
...
private:
    ...
    static constexpr units::turn_t kFrontLeftEncoderOffset = 0.155029296875_tr;
    static constexpr bool kFrontLeftSteerMotorInverted = true;
    static constexpr bool kFrontLeftEncoderInverted = false;

    static constexpr units::inch_t kFrontLeftXPos = 11.3125_in;
    static constexpr units::inch_t kFrontLeftYPos = 11.1325_in;
    ...
    static constexpr units::turn_t kFrontRightEncoderOffset = -0.141845703125_tr;
    static constexpr bool kFrontRightSteerMotorInverted = true;
    static constexpr bool kFrontRightEncoderInverted = false;

    static constexpr units::inch_t kFrontRightXPos = 11.3125_in;
    static constexpr units::inch_t kFrontRightYPos = -11.1325_in;
    ...
    static constexpr units::turn_t kBackLeftEncoderOffset = 0.036376953125_tr;
    static constexpr bool kBackLeftSteerMotorInverted = true;
    static constexpr bool kBackLeftEncoderInverted = false;

    static constexpr units::inch_t kBackLeftXPos = -11.3125_in;
    static constexpr units::inch_t kBackLeftYPos = 11.1325_in;
    ...
    static constexpr units::turn_t kBackRightEncoderOffset = -0.420166015625_tr;
    static constexpr bool kBackRightSteerMotorInverted = true;
    static constexpr bool kBackRightEncoderInverted = false;

    static constexpr units::inch_t kBackRightXPos = -11.3125_in;
    static constexpr units::inch_t kBackRightYPos = -11.1325_in;
